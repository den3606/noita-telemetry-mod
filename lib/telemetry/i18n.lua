...
local TEXT = {
  en = {
    ...
    connect_retry = "[NoitaTelemetry] Retrying connection ({attempt}/{max})",
    ...
    error_api_disallowed_mods = "Cloud upload blocked — disallowed mod(s){mods_detail}",
    error_api_client_version_mismatch = "Cloud upload blocked — MOD version outdated; update from Settings",
    ...
    error_api_open_failed = "Run session could not be opened ({api_message})",
  ...
  ja = {
    ...
    connect_retry = "[NoitaTelemetry] 再接続を試みます ({attempt}/{max})",
    ...
    error_api_disallowed_mods = "クラウド送信不可 — 許可されていない MOD{mods_detail}",
    error_api_client_version_mismatch = "クラウド送信不可 — MOD のバージョンが古いです。設定画面から更新してください",
    ...
    error_api_open_failed = "ランセッションを開始できませんでした ({api_message})",
