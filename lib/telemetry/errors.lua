...
local M = {
  ...
  api_open_failed = 112,
  api_client_version_mismatch = 114,
  api_unknown = 113,
  api_generic = 199,
  unknown = 99,
}
...
local MESSAGE_KEYS = {
  ...
  [M.api_client_version_mismatch] = "error_api_client_version_mismatch",
...
local API_SLUG_TO_CODE = {
  ...
  client_version_mismatch = M.api_client_version_mismatch,
  invalid_client_version = M.api_client_version_mismatch,
...
local CODE_TO_PHASE = {
  ...
  [M.api_client_version_mismatch] = error_phases.sync.open.http_poll,
...
M.NON_RETRYABLE_API_CODES = {
  ...
  [M.api_client_version_mismatch] = true,
